 ...
 */
public enum CrossMaterial implements Cross<CrossMaterial> {
	 ...
	 */
	public static Optional<CrossMaterial> get(String materialName) {
		for (CrossMaterial material : values()) {
			if (material.name() == materialName) return Optional.of(material);
		}
		return Optional.empty();
	}
	
	/**
	 * Attempt to get a CrossMaterial by their material id
	 * @param materialId id of material
	 * @return {@link Optional}
	 */
	public static Optional<CrossMaterial> get(int materialId) {
		for (CrossMaterial material : values()) {
			if (material.getMaterialId() == materialId) return Optional.of(material);
		}
		return Optional.empty();
	}
	...
	private CrossMaterial(int materialId) {
