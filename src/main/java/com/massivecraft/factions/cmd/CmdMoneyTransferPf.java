...
public class CmdMoneyTransferPf extends FCommand {
    ...
    public void perform() {
        ...
        if (success && Conf.logMoneyTransactions) {
            P.get().log(ChatColor.stripColor(P.get().txt.parse(TL.COMMAND_MONEYTRANSFERPF_TRANSFER.toString(), fme.getName(), Econ.moneyString(amount), from.describeTo(null), to.describeTo(null))));
        }
    }
